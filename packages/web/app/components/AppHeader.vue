...
<template>
  <header class="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md sticky top-0 z-50">
    <div class="p-3 flex items-center justify-between flex-wrap">
      <a title="¡Bienvenidos a Nuestra Tienda Online!" href="#">¡Bienvenidos a Nuestra Tienda Online!</a>

      <a title="+57 (301) 372-6605" href="tel:+57300-800-0000">+57 (301) 372-6605</a>
    </div>
    ...
    <UContainer class="h-16 flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xl font-bold text-gray-900 dark:text-white">Shopkids</span>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="w-fit h-fit relative">
          ...
          <UButton variant="outline" color="neutral" size="lg" icon="i-lucide-shopping-cart" to="/cart" />
        </div>
        <ColorMode />
      </div>
    </UContainer>
